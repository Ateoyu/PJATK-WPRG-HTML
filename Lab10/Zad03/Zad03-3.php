...
<head>
    ...
    <link rel='stylesheet' href="Zad03-3.css">
    <style>
        body {
            background-color: <?php echo $_SESSION['chosenBackground']; ?>;
            color: <?php echo $_SESSION['chosenTextColour']; ?>;;
        }
    </style>
</head>
<body>
<div class="output">
    ...
    <a href="Zad03.php" style="font-weight: bold">Go back to preference selection.</a>
</div>
</body>
